...
Summary(pl):	Przeno郾a biblioteka C do dynamicznego generowania plik闚 PDF
Name:		pdflib
Version:	4.0.3
Release:	13
...
%description -l pl
PDFlib to biblioteka w C do generowania plik闚 PDF. Oferuje ona API do
obs逝gi grafiki ze wsparciem dla rysowania, tekst闚, font闚, obrazk闚
oraz hipertekstu.
